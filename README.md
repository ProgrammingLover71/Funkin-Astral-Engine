...
# Modding
The engine is in a pretty unstable state, but full built-in mod support will come soon, probably with release 0.4.0 ( im saying it like ive got versioning on this shit :/ ).

Oh, and if you want to change the source or redistribute the engine, go wild. Just don't forget to credit me and the other developers of the engine (which, as of right now, *don't exist*)!

Have fun and happy funkin'!